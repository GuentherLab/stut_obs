function seqs = make_random_sit_cond(nType, lastRest, maxRep, nTrial, nSeq)
...
% conds = make_random_sit_cond(2,0,2,[6,6],2)
% conds = make_random_sit_cond(8,0,2,[6,6,6,6,6,6,6,6],2)
% disp(flvoice_design_efficiency('conditions', conds))